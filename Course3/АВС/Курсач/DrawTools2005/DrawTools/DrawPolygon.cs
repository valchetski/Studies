...
namespace DrawTools
{
    ...
    /// </summary>
    class DrawPolygon : DrawLine
    {
        private readonly PointList pointArray;         // list of points

        private static readonly Cursor handleCursor = new Cursor(typeof(DrawPolygon), "PolyHandle.cur");
        ...
        {
            pointArray = new PointList {new Point(x1, y1), new Point(x2, y2)};
        ...
        public override void Move(int deltaX, int deltaY)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                point = new Point(pointArray[i].X + deltaX, pointArray[i].Y + deltaY);
