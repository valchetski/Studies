...
namespace DrawTools
{
    partial class MainForm : Form
    {
        ...
        private DocHelper docManager;
        private DragDropHelper dragDropManager;
        private MruFilesHelper mruManager;
        ...
        /// </summary>
        /// <value></value>
        public ToolStripMenuItem ContextParent { get; private set; }
        ...
        {
            var command = new CommandDelete(drawArea.GraphicsList);
        ...
        {
            var command = new CommandDeleteAll(drawArea.GraphicsList);
        ...
        private void InitializeHelperObjects()
        {
            ...
            var data = new DocManagerData
            {
                FormOwner = this,
                UpdateTitle = true,
                FileDialogFilter = "DrawTools files (*.dtl)|*.dtl|All Files (*.*)|*.*",
                NewDocName = "Untitled.dtl",
                RegistryPath = registryPath
            };

            docManager = new DocHelper(data);
            ...
            // DragDropManager
            dragDropManager = new DragDropHelper(this);
            dragDropManager.FileDroppedEvent += (sender, e) => OpenDocument(e.FileArray.GetValue(0).ToString());

            // MruManager
            mruManager = new MruFilesHelper();
            ...
            mruManager.MruOpenEvent += (sender, e) => OpenDocument(e.FileName);
        }
        /// <summary>
        ...
        {
            docManager.SaveDocument(DocHelper.SaveType.Save);
        }
        ...
        {
            docManager.SaveDocument(DocHelper.SaveType.SaveAs);
        }
