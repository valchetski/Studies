...
namespace DocToolkit
{
    ...
    public class MruFilesHelper
    {
        ...
        private readonly StringList mruList;              // MRU list (file names)
        ...
        /// <param name="mruItemParent"></param>
        ...
        private void OnMruParentPopup(object sender, EventArgs e)
        {
            ...
            while (myEnumerator.MoveNext())
            {
                item = new ToolStripMenuItem {Text = GetDisplayName(myEnumerator.Current), Tag = i++};
        ...
        private string GetDisplayName(string fullName)
        {
            ...
            return GetShortDisplayName(fileInfo.DirectoryName == CurrentDir ? fileInfo.Name : fullName, maxDisplayLength);
        }
        ...
        private string GetShortDisplayName(string longName, int maxLen)
        {
            ...
            return PathCompactPathEx(pszOut, longName, maxLen, 0) ? pszOut.ToString() : longName;
        }
